...
folder are mapped to the application's root namespace, 'juegosmecanicos'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "juegosmecanicos"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'juegosmecanicos' in the same way
as `"juegosmecanicos/sass/src"`.
